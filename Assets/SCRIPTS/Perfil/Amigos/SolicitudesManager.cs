...
public class SolicitudesManager : MonoBehaviour
{
    ...
    void InitializeLocalizedTexts()
    {
        if (appIdioma == "ingles")
        {
            ...
            localizedTexts["defaultRank"] = "Lab Newbie"; // Aunque la lgica se basa en español, el default en UI puede cambiar
    ...
    {
        // Esta funcin depende de los valores en español de la base de datos.
