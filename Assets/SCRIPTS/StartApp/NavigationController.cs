...
public class NavigationController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Gestos t�ctiles en los bordes (solo para m�viles)
        if (Application.isMobilePlatform && Input.touchCount > 0)
        {
            ...
            switch (touch.phase)
            {
                case TouchPhase.Began:
                    // Verificar si el toque comenz� en el borde izquierdo o derecho
                ...
                case TouchPhase.Ended:
                    // Solo procesar si comenz� en el borde
                    if (touchStartPos != Vector2.zero)
                    {
                        ...
                        // Validar que sea un gesto r�pido y con suficiente distancia
    ...
    void OnSceneLoaded(Scene scene, LoadSceneMode mode)
    {
        ...
        // Solo guardamos en el historial si es una nueva escena (no al volver atr�s)
    ...
    // M�todo para cambiar de panel dentro de la misma escena
    public void ShowPanel(GameObject panel)
    {
        ...
        // Actualizar el �ltimo item del historial con el panel actual
    ...
    public void GoBack()
    {
        ...
        if (navigationHistory.Count > 1)
        {
            ...
            // Reactivar el panel que estaba activo en esa escena (si hab�a uno)
        ...
        {
            // Si no hay m�s historial, salir de la aplicaci�n
            Application.Quit();
        }
    }
